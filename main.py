...
def bill_button_operation():
    ...
    if ans == "yes":
        ...
        st = "\n\t\t\t\t\t\t\tRandika Super Centre\n\t\t\t\t\t\tNO 27/1 kirimatiyawa,ovilikandka\n"
        st += "\t\t\t\t\t\t\tTP.NO:- 077 8242896\n\n"
        st += "-"*63 + "BILL" + "-"*63 + "\nDate:- "
...
root.geometry("1201x664")
root.title("Shopping System - V1.0.2")
root.state("zoomed")
...
title_frame = Frame(root, bd=8, bg="#c0c0c0", relief=GROOVE)
title_frame.pack(side=TOP, fill="x")

title_label = Label(title_frame, text="Randika Super Centre", font=("times new roman", 20, "bold"), bg="#c0c0c0", fg="red", pady=5)
title_label.pack()
...
menu_label = Label(menu_frame, text="Menu", font=("times new roman", 20, "bold"), bg="lightgreen", fg="red", pady=0)
menu_label.pack(side=TOP, fill="x")

menu_category_frame = Frame(menu_frame, bg="lightgreen", pady=10)
menu_category_frame.pack(fill="x")

txtSearch1 = Label(menu_category_frame, text="Search", font=("arial", 12, "bold"), bg="lightgreen", fg="blue")
txtSearch1.grid(row=0,column=0,padx=10)

txtSearch = Entry(menu_category_frame, width=23)
txtSearch.grid(row=0, column=1, padx=10,pady=10,ipady=4)



combo_lable = Label(menu_category_frame, text="Select Type",font=("arial", 12, "bold"), bg = "lightgreen", fg="blue")
combo_lable.grid(row=1,column=0,padx=10)

menuCategory = StringVar()
combo_menu = ttk.Combobox(menu_category_frame, values=menu_category, textvariable=menuCategory)
combo_menu.grid(row=1,column=1,padx=30)

show_button = ttk.Button(menu_category_frame, text="Show",width=10,command=show_button_operation)
show_button.grid(row=1,column=2,padx=60)
...
#menu_tabel.heading("category",text="ID")
...
item_name_label = Label(item_frame2, text="Name",font=("arial", 12, "bold"),bg = "lightgreen", fg="blue")
...
item_rate_label = Label(item_frame2, text="Rate",font=("arial", 12, "bold"),bg = "lightgreen", fg="blue")
item_rate_label.grid(row=0,column=2,padx=40)

itemRate = StringVar()
itemRate.set("(no_data)")
...
item_quantity.grid(row=1,column=1,ipady=2)
...
#order_tabel.heading("id",text="id")
...
#order_tabel.column("id",width=100,anchor='center', stretch=NO)
...
###########################################################################################
total_Chash = Label(order_frame, text="Chash",font=("arial", 12, "bold"),bg = "lightgreen", fg="blue")
total_Chash.pack(side=LEFT,anchor=SW,padx=20,pady=10)

itemChash = StringVar()
itemChash.set("")
total_Chash = Entry(order_frame, font="arial 12",textvariable=itemChash, width=10)
total_Chash.pack(side=LEFT,anchor=SW,padx=0,pady=10)
...
#title_frame = Frame(root, bd=5, relief=GROOVE)
#title_frame.pack(side=BOTTOM, fill="x")

#title_label = Label(title_frame, text="Solution By : Click 2 Solutions Technologies (Pvt)Ltd",font=("times new roman", 10, "bold"), bg="#c0c0c0", fg="red", pady=5)
